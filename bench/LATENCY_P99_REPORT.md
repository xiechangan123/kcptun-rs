...
|------|--------:|---:|-----:|-------------:|--------------:|----:|----:|----:|-----:|----:|----:|----:|
| kcp-rs(tokio)↔kcp-rs(tokio) | 30000 | 30000 | 0 | 0 | 500 | 156.9 | 239.6 | 560.5 | 1589.9 | 175.3 | 64.4 | 11860.2 |
| kcp-go↔kcp-go            | 30000 | 30000 | 0 | 0 | 500 | 106.0 | 144.0 | 278.0 | 1289.0 | 127.7 | 50.0 | 31834.0 |
| kcp-rs(tokio)→kcp-go     | 30000 | 30000 | 0 | 0 | 500 | 167.0 | 259.9 | 682.9 | 3093.1 | 199.8 | 63.1 | 10075.5 |
| kcp-go→kcp-rs(tokio)     | 30000 | 30000 | 0 | 0 | 500 | 106.0 | 125.0 | 174.0 | 438.0 | 108.4 | 40.0 | 2565.0 |

## 最大可持续性能（闭环，concurrency=32）

| 组合 | completed req/s | P99 (µs) | P999 (µs) | max (µs) |
|------|----------------:|----------:|-----------:|---------:|
| kcp-rs(tokio)↔kcp-rs(tokio) | 199640 | 311.0 | 502.8 | 34649.0 |
| kcp-go↔kcp-go | 94091 | 639.0 | 914.0 | 8158.0 |
...
- **最大 raw KCP 吞吐**：kcp-rs(tokio) 199640 req/s，kcp-go 94091 req/s；Rust 相对 Go 为 112.2%（正数表示 Rust 更快）。
